...
import 'package:mobx_app/components/item_list.dart';
import 'package:mobx_app/screens/checkout.dart';
import 'package:mobx_app/store/carrinho_store.dart';
          ...
          slivers: <Widget>[
            ...
            SliverFillRemaining(
              ...
              child: Align(
                ...
                child: Observer(
                  builder: (_) => carrinhoStore.carrinhoVazio ? Container() : InkWell(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => Checkout(homeContext: homeContext)));
                    },
                    child: Ink(
